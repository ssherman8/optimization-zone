...
- Hardware
  - [NUMA](hardware/NUMA/README.md)
    ...
    - [Cloud Instances](hardware/NUMA/cloud_instances/README.md)
      - [GNR (8i) on AWS](hardware/NUMA/cloud_instances/aws_gnr.md)
      - [GNR (C4) on GCP](hardware/NUMA/cloud_instances/gcp_gnr.md)
      - [Cross-Cloud Comparison](hardware/NUMA/cloud_instances/cross_cloud.md)
